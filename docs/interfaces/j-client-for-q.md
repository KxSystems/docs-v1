...
<!-- FIXME
Table below renderts with misaligned columns because MkDocs produces ligatures
inside CODE elements. See bug report at
https://groups.google.com/forum/#!topic/mkdocs/w4WpMhDVuvQ
...
<i class="fa fa-hand-o-right"></i> [Interprocess communication](/ref/ipc) for the internal layout of messages
