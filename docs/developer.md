...
* [Efficient use of **adverbs**](db/efficient_use_of_adverbs.pdf)
* [**Compression** in kdb+](db/compression_in_kdb.pdf)
* [Temporal Data: a kdb+ framework for **corporate actions**](db/temporal_data_a_kdb_framework_for_corporate_actions.pdf)
* [Kdb+ **data-management sample customisation** techniques with amendments](db/kdb_data_management_sample_customisation_techniques_with_amendments.pdf)
* [**Data recovery** for kdb+tick](db/data_recovery_for_kdb_tick.pdf)
* [A natural query interface for **distributed systems**](db/a_natural_query_interface_for_distributed_systems.pdf)
* [Kdb+ and **FIX** messaging](db/kdb_and_fix_messaging.pdf)
* [The application of **foreign keys** and linked columns in kdb+](db/the_application_of_foreign_keys_and_linked_columns_in_kdb.pdf)
* [Common design principles for kdb+ **gateways**](db/common_design_principles_for_kdb_gateways.pdf)
* [An introduction to **graphical interfaces** for kdb+ using C#](db/an_introduction_to_graphical_interfaces_for_kdb_using_csharp.pdf)
* [Order Book: a kdb+ **intraday storage and access** methodology](db/order_book_a_kdb_intraday_storage_and_access_methodology.pdf)
* [**Intraday writedown** solutions](db/intraday_writedown_solutions.pdf)
* [Sample aggregation engine for **market depth**](db/sample_aggregation_engine_for_market_depth.pdf)
* [Market Fragmentation: a kdb+ framework for **multiple liquidity sources**](db/market_fragmentation_a_kdb_framework_for_multiple_liquidity_sources.pdf)
* [**Multi-partitioned** kdb+ databases: an equity options case study](db/multi_partitioned_kdb_databases_an_equity_options_case_study.pdf)
* [**Multi-threading** in kdb+ performance optimisations and use cases](db/multi_threading_in_kdb_performance_optimisations_and_use_cases.pdf)
* [An introduction to **neural networks** with kdb+](db/an_introduction_to_neural_networks_with_kdb.pdf)
* [**Parse trees** and functional forms](db/parse_trees_and_functional_forms.pdf)
* [**Permissions** with kdb+](db/permissions_with_kdb.pdf)
* [Columnar database and **query optimization**](db/columnar_database_and_query_optimization.pdf)
* [Kdb+ **query scaling**](db/kdb_query_scaling.pdf)
* [Building **real-time tick subscribers**](db/building_real_time_tick_subscribers.pdf)
* [Query Routing: a kdb+ framework for a **scalable load-balanced** system](db/query_routing_a_kdb_framework_for_a_scalable_load_balanced_system.pdf)
* [**Surveillance** techniques to effectively monitor algo and high-frequency trading](db/surveillance_techniques_to_effectively_monitor_algo_and_high_frequency_trading.pdf)
* [Kdb+tick profiling for **throughput optimization**](db/kdbtick_profiling_for_throughput_optimization.pdf)
* [**Time series simplification** in kdb+: a method for dynamically shrinking big data](db/time_series_simplification_in_kdb_a_method_for_dynamically_shrinking_big_data.pdf)
* [**Transaction-cost** analysis using kdb+](db/transaction_cost_analysis_using_kdb.pdf)
* [Kdb+ and **WebSockets**](db/kdb_and_websockets.pdf)
