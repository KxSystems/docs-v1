...
Sets <a href="#data-source">Data Source</a> and data type to plot on the chart. With Layers, it's possible for data from different data sources to be plotted on a single chart. 
