...
<tr><td>I</td><td>[`ij`](joins/#ij-ijf-inner-join "inner join"), [`in`](search/#in "membership"), [`insert`](qsql/#insert "append records to a table"), [`inter`](select/#inter "items common to both arguments")</td></tr>
...
<tr><td>U</td><td>[`uj`](joins/#uj-ujf-union-join "union join"), [`union`](select/#union "distinct items of combination of two lists"), [`upsert`](qsql/#upsert "add table records")</td></tr>
