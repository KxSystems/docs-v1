...
<tr><td>con</td> <td/> <td>qcon client is not supported when kdb+ is in [multithreaded input mode](/cookbook/multithreaded-input/)</td> </tr>
...
<tr> <td>path too long</td> <td>``(`$":",1000#"a") set 1 2 3``</td> <td>File path ≥255 chars (100 until V3.6 2018.09.26)</td> </tr> 
