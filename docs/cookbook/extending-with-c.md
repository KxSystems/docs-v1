...
You will need <i class="fa fa-github"></i> [`k.h`](https://github.com/KxSystems/code.archive/blob/master/kx/kdb%2B/c/c/k.h) 
...
add
```
To ensure that the linker can find `kj()`, we link with <i class="fa fa-github"></i> [w32/q.lib](https://github.com/KxSystems/code.archive/blob/master/kx/kdb%2B/w32/q.lib) or [w64/q.lib](https://github.com/KxSystems/code.archive/blob/master/kx/kdb%2B/w64/q.lib) The .lib contains stub code that links to the `kj()` function in q.exe.
...
Source code: <i class="fa fa-github"></i> [KxSystems/code.archive/cookbook_code/cpu_extension](https://github.com/KxSystems/code.archive/tree/master/cookbook_code/cpu_extension)
