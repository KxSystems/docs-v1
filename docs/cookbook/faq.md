...
```
<i class="fa fa-hand-o-right"></i> [Datatypes](/ref/datatypes)
...
20  oil 77
```
<i class="fa fa-hand-o-right"></i> [`0:`](/ref/filenumbers/#0-text-files) (Text files)
...
q)save `:trade.txt
```
<i class="fa fa-hand-o-right"></i> [`save`](/ref/filewords/#save)
...
<i class="fa fa-external-link"></i> [Shebang (Unix)](http://en.wikipedia.org/wiki/Shebang_(Unix))
