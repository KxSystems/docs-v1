...
The “tools” you have to work with are the `p`? functions from `.z`: [`.z.po`](/ref/dotz/#zpo-open "open"), [`.z.pc`](/ref/dotz/#zpc-close "close"), [`.z.pw`](/ref/dotz/#zpw-validate-user "validate user"), [`.z.pg`](/ref/dotz/#zpg-get "get"), [`.z.ps`](/ref/dotz/#zpg-set "set"), [`.z.ph`](/ref/dotz/#zph-http-get "HTTP get"), [`.z.pp`](/ref/dotz/#zpp-http-post "HTTP post") and [`.z.exit`](/ref/dotz/#zexit-action-on-exit "action on exit"). Combined with the `.z` variables [`.z.a`](/ref/dotz/#za-ip-address "IP address"), [`.z.u`](/ref/dotz/#zu-user-id "user ID") and [`.z.w`](/ref/dotz/#zw-handle "handle") which are always set to the values of the _client_ during execution of the `.z.p`? function. Depending on how the function is called, additional information may be provided as arguments to the `.z.p`? functions (user ID and password for `.z.pw`, browser environment for `.z.ph` and `.z.pp`).

By default, execution is done using [`value`](/ref/metadata/#value) so strings or symbol argument lists can be tested in a console.  
...
- [`.z`](/ref/dotz/ ".z namespace")
- [Changes in V2.4](/ref/releases/ChangesIn2.4/)
