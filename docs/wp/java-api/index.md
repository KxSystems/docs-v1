...
The API is contained in a single source file, <i class="fa fa-github"></i>
...
Both of these constructor families represent two ‘modes’ into which
...
<!-- FIXME Recast preceding sentence. -->
